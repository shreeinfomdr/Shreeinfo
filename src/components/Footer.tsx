...
export default function Footer({ content }: { content?: any }) {
  ...
  const tagline = content?.footerTagline || 'Your trusted IT partner since 2005. Delivering innovative technology solutions in Mundra, Gujarat.';
  const address = content?.address || 'Mundra, Gujarat';
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.footerContent}>
        ...
        <div>
          ...
          <div className={styles.contactItem}>
            ...
            <a href={`https://wa.me/${phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer">WhatsApp Us</a>
          </div>
        </div>
        ...
        <div>
          ...
          <div className={styles.contactItem} style={{ alignItems: 'flex-start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              <span>Morning: {hoursMorning}</span>
              <span>Evening: {hoursEvening}</span>
            </div>
          </div>
          <div className={styles.contactItem}>
      ...
      <div className={styles.bottomBar}>
        <p className={styles.copyright}>
          © {new Date().getFullYear()} <a href="#home">Shree Infotech</a>. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
