...
export default function Services({ content }: { content?: any }) {
  ...
  const services = [
    {
      title: content?.service1Title || 'Laptop Chip Level Repair',
      description: content?.service1Desc || "Expert motherboard and chip-level diagnostics and repair services for all laptop brands. We fix what others can't.",
    ...
    {
      title: content?.service2Title || 'Water Damage Repair',
      description: content?.service2Desc || 'Professional water damage recovery and restoration for laptops and electronic devices. Fast turnaround with high success rate.',
    ...
    {
      title: content?.service3Title || 'Screen Replacement',
      description: content?.service3Desc || 'Quick and reliable screen replacement service with genuine quality displays for all major laptop and monitor brands.',
